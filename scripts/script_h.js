    ...
    h.addEventListener('mouseenter', () => {
        ...
        poyasnenie.innerHTML='гортанный, щелевой звук; при произнесении корейского - х, звук произносится очень легко; в положении между гласными и после сонорных согласных (ㄴ, ㅁ, ㅇ, ㄹ) на слух почти не слышен';
    });
