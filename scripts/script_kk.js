...
let stagekk = 1;
const speedkk = 0.01;
const totalStageskk = 4;
let filledStageskk = [false, false, false, false];
...
function drawSymbolkk(progresskk) {
    ...
    ctxkk.fillRect(10, 50, 80, 20); //  1 линия gor
    
    ctxkk.fillRect(70, 50, 20, 100);  // 1  линия vert

    ctxkk.fillRect(100, 50, 80, 20); // 2 линия gor
    
    ctxkk.fillRect(160, 50, 20, 100);  // 2 линия vert
...
if (filledStageskk[0] || stagekk === 1) {
        ...
        ctxkk.fillRect(10, 50, 80 * lineProgresskk, 20);
    }

    // 1 вертикальная линия
    if (filledStageskk[1] || stagekk === 2) {
        const lineProgresskk = filledStageskk[1] ? 1 : Math.min(progresskk, 1);
        ctxkk.fillRect(70, 50, 20, 100 * lineProgresskk);
    }
        //   2 gorizont 
    if (filledStageskk[2] || stagekk === 3) {
        const lineProgresskk = filledStageskk[2] ? 1 : Math.min(progresskk, 1);
        ctxkk.fillRect(100, 50, 80 * lineProgresskk, 20);
    }

    // 2 вертикальная линия
    if (filledStageskk[3] || stagekk === 4) {
        const lineProgresskk = filledStageskk[3] ? 1 : Math.min(progresskk, 1);
        ctxkk.fillRect(160, 50, 20, 100 * lineProgresskk);
    }
